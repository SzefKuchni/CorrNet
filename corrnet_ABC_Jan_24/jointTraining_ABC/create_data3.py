...
def get_mat1(folder,mat1,mat2,mat3):
	...
	while(i!=len(mat1)):
		...
		if(i%1000==0):
			...
			numpy.save(folder+str(i/1000)+"_middle",smat2)
			numpy.save(folder + str(i / 1000) + "_right", smat3)
	...
	if(flag!=0):
		...
		numpy.save(folder+str((i/1000) +1)+"_middle",smat2)
		numpy.save(folder + str((i / 1000) + 1) + "_right", smat3)
...
def converter(folder):
	...
	mat3 = get_mat(folder+"train-view3.txt")
	get_mat1(folder+"matpic1/train/",mat1,mat2,mat3)
	...
	mat3 = get_mat(folder+"valid1-view3.txt")
	numpy.save(folder+"matpic/train/view3",mat3)
	...
	mat3 = get_mat(folder+"valid2-view3.txt")
	numpy.save(folder+"matpic/valid/view3",mat3)
	get_mat1(folder+"matpic1/valid/",mat1,mat2,mat3)
	...
	mat3 = get_mat(folder+"test-view3.txt")
	numpy.save(folder+"matpic/test/view3",mat3)
	get_mat1(folder+"matpic1/test/",mat1,mat2,mat3)
